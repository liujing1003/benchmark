...
parser.add_argument('--dataset', dest='dataset', default='cub', type=str,
...
def main():
    ...
    if args.tensorboard: configure("runs_cub/%s"%(args.expname))
    ...
    numberofclass = 200  # changed to 200
    if args.dataset == 'cifar100':
        ...
        train_loader = torch.utils.data.DataLoader(
            datasets.ImageFolder('/media/ouc/30bd7817-d3a1-4e83-b7d9-5c0e373ae434/LiuJing/data/cub', transform=transform_train),
            batch_size=args.batchsize, shuffle=True, **kwargs)
        val_loader = torch.utils.data.DataLoader(
            datasets.ImageFolder('/media/ouc/30bd7817-d3a1-4e83-b7d9-5c0e373ae434/LiuJing/data/cub', transform=transform_test),
            batch_size=args.batchsize, shuffle=True, **kwargs)
	numberofclass = 200
    else: 
